...
<h1 class="first">Registrazione Autista</h1>
    ...
    <div class="row">
		<div class="col-md-8 col-md-offset-2">   
			...
			<div class="col-md-6 mb-3">
      			...
      			<input type="text" class="form-control is-invalid" <%if (u!=null){ %> value="<%=u.getStipendio() %>"<%} %> name="stipendio">
      				<div class="invalid-feedback">
       			 	<%=errorMap.get("stipendio empty")%>
      				</div>
      			<%}else {%>
      			<input type="text" class="form-control is-valid" <%if (u!=null){ %> value="<%=u.getStipendio() %>"<%} %> name="stipendio">
      			<%} %>
    		</div>    		
    	</div>
    </div>
